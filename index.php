...
<html lang="en">
	<head>
	    ...
	    <title>Online Shopping Portal Home Page</title>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets/images/11.jpg">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(assets/images/sliders/13.png);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/11.jpg);">
			</div><!-- /.item -->
		</div>
		<div class="full-width-slider">
		...
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/15.jpg);">
			</div><!-- /.item -->
		...
		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/17.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">07 Day Money Back Guarantee.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">fast shipping</h4>
						</div>
					</div>
